  ...
  <nav class="content desktop sideShadows">
    ...
    <ul id="ulNavSocials" class="ulNav">
      <NavLink title="" :href="GITHUB_URL">
        <svg class="svgNav" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" fill="currentColor" aria-labelledby="titleGitHub">
          <title id="titleGitHub">GitHub</title>
      ...
      <NavLink title="" :href="LINKEDIN_URL">
        <svg class="svgNav" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" aria-labelledby="titleLinkedIn">
